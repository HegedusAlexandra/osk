...
export default function Contact() {
  ...
  return (
    <div
      className="w-[100%] md:h-[80vh] flex flex-row justify-center items-start bg-white/80 pb-[4vh]"
      id="informationcontainer"
    >
      <div
        id="information"
        className="flex md:flex-row flex-col justify-center items-center w-[95%] md:h-[70vh] bg-white backdrop-blur-xl imgBoxShadow rounded-sm"
      >
        <div className="flex flex-row justify-center items-center md:w-[50%]">
          <div className="md:w-[50%] w-[100%] h-[50vh] flex justify-center items-center">
            <table className="md:w-[80%] w-[100%]">
              <thead>
                <tr className="md:h-[12vh] text-[3vh] font-bold">
        ...
        <div className="md:w-[50%] w-[100%] md:h-[70vh] h-[30vh]">
          <iframe
            title="map"
            ...
            className="w-[100%] md:h-[70vh] h-[30vh]"
          ></iframe>
        </div>
      </div>
    </div>
